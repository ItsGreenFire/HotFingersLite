...
pg.init()
clock = pg.time.Clock()
homeDir = os.path.expanduser("~\\AppData\\LocalLow\\HotFingersLite")
...
def main():
    ...
    hotkey = 'r'
    toggleActive = False
    pg.display.set_icon(pg.image.load(homeDir + '\\wiiCursor.png'))
    ...
    while not done:
        ...
        # Blits
        screen.blit(pg.image.load(homeDir + "\\wiiCursorLarge.png"), (105, 30))
